...
/* Generated from ../O.Common/myPID.dbd */
...
epicsShareExtern dset *pvar_dset_devAaiSoft, *pvar_dset_devAaoSoft,
    ...
    *pvar_dset_devmyPIDVersion, *pvar_dset_devLsoSoft,
...
static const char * const deviceSupportNames[] = {
    ...
    "devLoSoftCallback", "devLsiSoft", "devLsiEnviron", "devmyPIDVersion",
...
epicsShareExtern reg_func pvar_func_QSRVRegistrar,
    ...
    pvar_func_dlloadRegistar, pvar_func_helloRegister,
    pvar_func_initTraceRegister, pvar_func_refTrackRegistrar,
...
int myPID_registerRecordDeviceDriver(DBBASE *pbase)
{
    static int executed = 0;
    const char *bldTop = "/home/codac_user/myPID";
...
static const iocshFuncDef rrddFuncDef =
    {"myPID_registerRecordDeviceDriver", 1, rrddArgs};
static void rrddCallFunc(const iocshArgBuf *)
{
    myPID_registerRecordDeviceDriver(*iocshPpdbbase);
}
